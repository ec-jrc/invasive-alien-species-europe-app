...
.constant('CONFIG', {
	...
	serverTestApiUrlHttp: 'https://easin.jrc.ec.europa.eu/mobile_test/',
	serverTestApiUrlHttps: 'https://easin.jrc.ec.europa.eu/mobile_test/',
	// TEST ------------------------------------------------------------------------
	serverProdApiUrlHttp: 'http://vap-mygeoss-data.jrc.it/easin/backend/',
	serverProdApiUrlHttps: 'https://vap-mygeoss-data.jrc.it/easin/backend/',
